...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Deriandri/ip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Pasang
else
...
mkdir /root/listip
cd /root/listip
wget https://raw.githubusercontent.com/Deriandri/ip/main/izin >/dev/null 2>&1
...
res1() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/install/pointing.sh && chmod +x pointing.sh && ./pointing.sh
clear
}
clear
cd
...
function Pasang(){
cd
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/Deriandri/suryafa/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Deriandri/ip/main/izin | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Deriandri/suryafa/main/versi  )
...
rm /usr/bin/lesskey >/dev/null 2>&1
rm /usr/bin/warning >/dev/null 2>&1
